...
{
  if (onPtr != 0 && strncmp(message, "on", 2) == 0)
  {
    (*onPtr)();
  }
  else if (offPtr != 0 && strncmp(message, "off", 3) == 0)
  {
    (*offPtr)();
  }
  else if (onPtr != 0 && strncmp(message, "1", 1) == 0)
  {
    (*onPtr)();
  }
  else if (offPtr != 0 && strncmp(message, "0", 1) == 0)
  {
    (*offPtr)();
  }
  else if (togglePtr != 0 && strncmp(message, "toggle", 6) == 0)
  {
    (*togglePtr)();
  }
